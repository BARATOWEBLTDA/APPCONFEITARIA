    ...
    <div className="auth-root">
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-divider { display: flex; align-items: center; gap: 0.75rem; color: #d1d5db; font-size: 0.82rem; }
        .auth-divider::before, .auth-divider::after { content: ''; flex: 1; height: 1px; background: #e5e7eb; }
        .google-btn { display: flex; align-items: center; justify-content: center; gap: 10px; padding: 0.75rem; background: white; color: #374151; border: 1.5px solid #e5e7eb; border-radius: 8px; font-family: 'DM Sans', sans-serif; font-size: 0.95rem; font-weight: 500; cursor: pointer; transition: border-color 0.2s, box-shadow 0.2s; width: 100%; }
        .google-btn:hover { border-color: #d1d5db; box-shadow: 0 1px 4px rgba(0,0,0,0.08); }
        @keyframes spin { to { transform: rotate(360deg); } }
        .cadastro-back-inline { position: absolute; top: 1.25rem; left: 1.25rem; width: 36px; height: 36px; border-radius: 50%; background: #f3f4f6; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; color: #374151; transition: background 0.15s; }
        .cadastro-back-inline:hover { background: #e5e7eb; }
