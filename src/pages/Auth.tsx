          ...
          <div className="cadastro-modal">
            ...
            <form onSubmit={handleCadastro} className="cadastro-form">
              <div className="cad-field">
                <input type="text" placeholder="Nome" value={cadastroForm.nome}
                  onChange={e => setCadastroForm({ ...cadastroForm, nome: e.target.value })} required />
              ...
              <div className="cad-field">
                <input type="tel" placeholder="Telefone" value={cadastroForm.telefone}
              ...
              <div className="cad-field">
                <input type="email" placeholder="E-mail" value={cadastroForm.email}
                  onChange={e => setCadastroForm({ ...cadastroForm, email: e.target.value })} required />
              ...
              <div className="cad-field">
                <input type={showCadastroSenha ? "text" : "password"} placeholder="Senha" value={cadastroForm.senha}
                  onChange={e => setCadastroForm({ ...cadastroForm, senha: e.target.value })} required />
              ...
              <div className="cad-field">
                <input type={showConfirmarSenha ? "text" : "password"} placeholder="Confirmar Senha" value={cadastroForm.confirmarSenha}
                  onChange={e => setCadastroForm({ ...cadastroForm, confirmarSenha: e.target.value })} required />
              ...
              <div className="cadastro-link-wrap">
                ...
                <button type="button" className="cadastro-link" onClick={() => setShowCadastro(false)}>
                  Fazer login
                </button>
              </div>
            </form>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-btn {
          ...
          font-size: 1rem; font-weight: 600; cursor: pointer; transition: opacity 0.2s, transform 0.15s;
        ...
        .auth-footer { position: fixed; bottom: 0; left: 0; right: 0; z-index: 3; background: rgba(180,0,90,0.2); backdrop-filter: blur(12px); padding: 0.9rem 1rem; text-align: center; }
        ...
        .cadastro-modal {
          ...
          position: relative; animation: slideUp 0.3s cubic-bezier(0.16, 1, 0.3, 1) both;
        ...
        .cad-field {
          ...
          border: 1.5px solid #e5e7eb; border-radius: 50px; overflow: hidden;
          background: white; transition: border-color 0.2s;
        }
        .cad-field:focus-within { border-color: #f9007a; }
        .cad-field input {
          flex: 1; padding: 0.8rem 1.25rem; border: none; outline: none;
          font-family: 'DM Sans', sans-serif; font-size: 0.95rem; color: #1f2937;
