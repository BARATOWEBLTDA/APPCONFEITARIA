  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .ntf-adm-list { display: flex; flex-direction: column; gap: 0; background: white; border-radius: var(--radius-lg); overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
        ...
        .ntf-adm-empty p { font-size: var(--font-button); margin: 0; }
        ...
        .ntf-adm-img { width: 56px; height: 56px; border-radius: var(--radius-sm); background: #f3f4f6; flex-shrink: 0; overflow: hidden; display: flex; align-items: center; justify-content: center; font-size: var(--text-xl); }
        .ntf-adm-img img { width: 100%; height: 100%; object-fit: cover; }
        .ntf-adm-content { flex: 1; min-width: 0; }
        .ntf-adm-titulo { font-size: var(--font-button); font-weight: var(--fw-bold); color: #1f2937; margin: 0 0 0.2rem; }
        .ntf-adm-msg { font-size: var(--font-helper); color: #6b7280; margin: 0; line-height: 1.4; }
        .ntf-adm-tag { font-size: var(--font-caption); font-weight: var(--fw-semibold); color: #f9007a; }
        .ntf-adm-time { font-size: var(--font-caption); color: #9ca3af; }
        .ntf-adm-delete { background: #fff1f2; border: none; width: 32px; height: 32px; border-radius: var(--radius-sm); cursor: pointer; font-size: var(--font-button); flex-shrink: 0; display: flex; align-items: center; justify-content: center; }
        ...
        .ntf-form-modal { background: white; border-radius: var(--radius-xl); width: 100%; max-width: 480px; max-height: 90vh; overflow-y: auto; padding: 1.5rem; }
        .adm-modal-close { background: #f3f4f6; border: none; width: 28px; height: 28px; border-radius: 50%; cursor: pointer; font-size: var(--font-helper); display: flex; align-items: center; justify-content: center; }
        .ntf-form-img { width: 100%; height: 120px; background: #f9fafb; border: 2px dashed #e5e7eb; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; cursor: pointer; margin-bottom: 1rem; overflow: hidden; transition: border-color 0.2s; }
