  ...
  return (
    <div className="ass-root">
      ...
      <style>{`
        ...
        .ass-trial-badge { display: inline-flex; align-items: center; gap: 0.4rem; background: linear-gradient(135deg,#F583BF,#e060a8); color: white; font-size: 0.78rem; font-weight: 700; padding: 0.35rem 0.9rem; border-radius: 20px; margin: 0 auto; display: flex; width: fit-content; }
        ...
        .ass-check-rosa {
          ...
          flex-shrink: 0;
          box-shadow: 0 2px 6px rgba(245,131,191,0.4);
        }
