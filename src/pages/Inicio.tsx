  ...
  return (
    <div className="ini-root">
                    ...
                    <div key={c.id} style={{ display: "flex", alignItems: "center", gap: "0.75rem", padding: "0.5rem 0", borderBottom: "1px solid var(--border, #E9E9EE)" }}>
                      <div style={{ width: "34px", height: "34px", borderRadius: "50%", background: "#f5f3ff", overflow: "hidden", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                        {c.foto_url
                          ...
                          : <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6366f1" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
                        }
                      </div>
      ...
      <style>{`
        ...
        .mob-config-card { background: linear-gradient(135deg, #1a1a2e, #16213e); border-radius: 16px; padding: 1.1rem 1.2rem; box-shadow: 0 6px 24px rgba(0,0,0,0.2); position: relative; overflow: hidden; }
        .mob-config-card::before { content: ''; position: absolute; top: -40px; right: -40px; width: 140px; height: 140px; border-radius: 50%; background: rgba(249,0,122,0.1); }
        ...
        .mob-resgatar-btn { width: 100%; padding: 0.85rem; background: linear-gradient(135deg, var(--primary, #FF6FA9), #c94d91, var(--primary, #FF6FA9)); background-size: 200% 200%; animation: gradientShift 3s ease infinite; border: none; border-radius: 50px; color: white; font-family: inherit; font-size: 0.95rem; font-weight: 700; cursor: pointer; margin-top: 0.25rem; transition: opacity 0.2s, transform 0.1s; letter-spacing: 0.3px; }
        ...
        .mob-assinar-btn-sm { padding: 0.55rem 1.75rem; background: linear-gradient(135deg, var(--primary, #FF6FA9), #e060a8); border: none; border-radius: 50px; color: white; font-family: inherit; font-size: 0.85rem; font-weight: 700; cursor: pointer; transition: opacity 0.2s, transform 0.1s; white-space: nowrap; }
        .mob-assinar-btn-sm:hover { opacity: 0.9; }
        .mob-assinar-btn-sm:active { transform: scale(0.97); }
        .mob-pro-mini-card { background: linear-gradient(135deg, #1a0a12, #2d0f1e); border-radius: 16px; padding: 0.85rem 1rem; display: flex; flex-direction: column; }
