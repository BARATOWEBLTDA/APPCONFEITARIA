...
export default function PedidoForm() {
  ...
  return (
    <div className="pf-root">
      ...
      <style>{`
        .pf-root { font-family: 'Geist', sans-serif; display: flex; flex-direction: column; gap: 1rem; max-width: 700px; padding-bottom: 5rem; }
        ...
        .pf-aba { flex: 1; display: flex; flex-direction: column; align-items: center; gap: 2px; background: none; border: none; border-radius: 8px; padding: 0.5rem 0.25rem; cursor: pointer; font-family: 'Geist', sans-serif; transition: background 0.15s; min-width: 60px; }
