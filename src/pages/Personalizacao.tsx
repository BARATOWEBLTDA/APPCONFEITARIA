  ...
  return (
    <div className="per-root">
      ...
      <style>{`
        ...
        .per-title { font-size: 1.4rem; font-weight: 700; color: var(--text-primary, #1f2937); margin: 0 0 0.25rem; }
        ...
        .per-card-icon { color: #F583BF; display: flex; align-items: center; flex-shrink: 0; }
        .per-card-title { font-size: 0.95rem; font-weight: 700; color: var(--text-primary, #1f2937); margin: 0; }
        .per-card-sub { font-size: 0.75rem; color: var(--text-muted, #9ca3af); margin: 0.15rem 0 0; }
        .per-pro-badge { margin-left: auto; background: linear-gradient(135deg,#F583BF,#e060a8); color: white; font-size: 0.68rem; font-weight: 700; padding: 0.2rem 0.6rem; border-radius: 20px; flex-shrink: 0; }

        .per-locked { background: var(--bg-subtle, #f9fafb); border-radius: 12px; padding: 1rem; text-align: center; }
        .per-locked p { font-size: 0.85rem; color: var(--text-secondary, #6b7280); margin: 0 0 0.75rem; }
        .per-assinar-btn { padding: 0.6rem 1.5rem; background: linear-gradient(135deg,#F583BF,#e060a8); color: white; border: none; border-radius: 50px; font-family: inherit; font-size: 0.85rem; font-weight: 700; cursor: pointer; }

        .per-temas { display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem; }
        .per-tema-btn {
          display: flex; flex-direction: column; gap: 0.6rem;
          padding: 0.85rem; border: 2px solid var(--border, #e5e7eb);
          border-radius: 16px; background: var(--bg-subtle, #f9fafb);
          cursor: pointer; transition: all 0.2s; position: relative;
          font-family: inherit; text-align: left;
        }
        .per-tema-btn.active { border-color: #F583BF; background: #fdf2f8; }
        .per-tema-btn:hover { border-color: #F583BF; }
        ...
        .per-tema-preview--light { background: #f9fafb; border: 1px solid #e5e7eb; }
        .per-tema-preview--dark  { background: #1a1a1a; border: 1px solid #333; }

        .per-preview-header { height: 12px; border-radius: 4px; background: #F583BF; width: 60%; }
        .per-preview-header--dark { background: #F583BF; }
        .per-preview-card { flex: 1; border-radius: 6px; background: white; padding: 4px; display: flex; flex-direction: column; gap: 3px; }
        .per-preview-card--dark { background: #2a2a2a; }
        .per-preview-card div { height: 4px; border-radius: 2px; background: #e5e7eb; }
        ...
        .per-tema-name { font-size: 0.85rem; font-weight: 700; color: var(--text-primary, #1f2937); }
        .per-tema-desc { font-size: 0.72rem; color: var(--text-muted, #9ca3af); }
        .per-tema-check { position: absolute; top: 0.6rem; right: 0.6rem; width: 20px; height: 20px; background: #F583BF; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.7rem; font-weight: 700; }
